...
%
% See also
%   PVL_DISC   PVL_EPHEMERIS   PVL_DATE2DOY   PVL_ALT2PRES
...
% Create DelKtPrime. If we have chosen to not utilize the time-series
% nature of data (ie. UseDelKtPrime ~=0), then create a signal to use Bin
% 7. If we have time-series data (ie. number of input elements >=2) and we
