...
%   library of Sandia Inverter model parameters [2]. SNLInverterDB is a vector
%   of structures which describe each inverter in the SAM library. one
%   element per inverter in the library. InverterNames is a cell column
%   vector of the names of each inverter in the library, thus
%   InverterNames{n} is the same as SNLInverterDB(n).name.
%
% Input Parameters:
