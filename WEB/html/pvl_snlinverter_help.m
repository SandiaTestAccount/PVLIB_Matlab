...
%% Description
% Computes the AC power output using the Sandia photovoltaic inverter model.
%
%% Inputs
%%
...
%     Data\SandiaInverterDatabaseSAM2012.11.30.mat|), or may be
%     generated from a System Advisor Model (SAM) [2] library using the SAM
%     library reader function (|pvl_SAMLibraryReader_SNLInverters.m|). 
...
% required), then |ACPower| is set to -1*abs(Pnt) to represent nightly power
% losses.

%% Example 1
load 'SandiaInverterDatabaseSAM2012.11.30.mat';
% PV Powered PVP2500 is entry #561
