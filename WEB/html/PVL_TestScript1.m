...
% Define the PV Inverter from the Sandia PV Inverter Database.
%
% This step uses the PV_LIB function
% <pvl_snlinverterdb_help.html |pvl_snlinverterdb|> to extract a selected
% inverter from the excel version of the Sandia PV Inverter Database.  The
% inverter is selected by using its unique ID (176) in that file.
% NOTE: This function will be removed in future releases.
Inverter = pvl_snlinverterdb(176, 'Inverters_2012.1.12.xlsx')

%% 0.2.1 Preferred way to Define the Inverter (Version 1.1)
...
load('SandiaInverterDatabaseSAM2012.11.30.mat')
% PV Powered PVP2500 inverter is #561 in the InverterNames cell array
Inverter = SNLInverterDB(561)
