...
%% Inputs
%%
% * *|Year|* - scaler or vector of years (e.g. 1990). |Year(i)| corresponding 
%              to |Month(i)| and |Day(i)|. 
% * *|Month|* - scaler or vector of month numbers (1-12). |Month| must be >=1 and <13
% * *|Day|* - scaler or vector of day of month numbers.   
